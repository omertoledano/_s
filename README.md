...
1. Search for `'Atlas'` (inside single quotations) to capture the text domain.
2. Search for `_atlas_` to capture all the function names.
3. Search for ` _atlas` (with a space before it) to capture DocBlocks.
4. Search for `_atlas-` to capture prefixed handles.

OR

* Search for: `'Atlas'` and replace with: `'megatherium'`
* Search for: `_atlas_` and replace with: `megatherium_`
* Search for: <code>&nbsp;_s</code> and replace with: <code>&nbsp;Megatherium</code>
* Search for: `_atlas-` and replace with: `megatherium-`
